...
public class ProdutoRendaFixaFactory implements IFactoryProduto {

	@Override
	public Produto createBy(DTOProduto dto) {
		return new ProdutoRendaFixa(dto.id(), dto.nome(), dto.descricao(), dto.rendimentoMensal(), dto.carencia());
	}
