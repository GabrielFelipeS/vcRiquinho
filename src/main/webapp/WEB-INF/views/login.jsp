					...
					<div class="card-body p-5 text-center">
						<form action="login" method="post" class="row g-3">
							...
							<label class=form-label for="email">Email:</label> <input
								type="text" class="form-control" name="email" required> <label
								class=form-label for="password"> Password:</label> <input
								type="password" class="form-control" name="password" required> <input
								type="submit" value="login" id="logar" class="form-control input-custom">
						</form>
					</div>
				</div>
			</div>
