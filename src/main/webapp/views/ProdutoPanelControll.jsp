...
<body>
	...
	<erro:message attribute="erroProduto"></erro:message>
				...
				<table class="table table-striped table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><%=produto.getCarencia()%></td>
							<td><%=produto.tipoProduto().replace("_", " ")%></td>
							<td><%=produto.getRendimentoMensal()%></td>
							<td><a href="#editEmployeeModal" class="edit"
								data-toggle="modal"><i class="material-icons"
									data-toggle="tooltip" title="Edit">&#xE254;</i></a> <a href="#"
								data-id="<%=produto.getId()%>" class="delete"
								data-toggle="modal"><i class="material-icons"
